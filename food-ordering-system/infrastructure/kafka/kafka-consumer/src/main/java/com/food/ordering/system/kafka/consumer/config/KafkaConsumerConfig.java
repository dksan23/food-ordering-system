...
@Configuration
public class KafkaConsumerConfig <T extends Serializable, V extends SpecificRecordBase> {
    ...
    @Bean
    public ConsumerFactory<T, V> consumerFactory()
    {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<T,V>> kafkaListenerContainerFactory()
    {
        ConcurrentKafkaListenerContainerFactory<T,V> factory = new ConcurrentKafkaListenerContainerFactory<>();
